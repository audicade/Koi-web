				...
				<section id="header">
					<div class="container">
						...
						<!-- Nav -->
							<nav id="nav">
								<ul>
									<li><a class="icon solid fa-home" href="{{ route('index') }}"><span>Introduction</span></a></li>
									<li>
									...
									<li><a class="icon solid fa-cog" href="{{ route('leftSidebar') }}"><span>Left Sidebar</span></a></li>
									<li><a class="icon solid fa-retweet" href="{{ url('/rsidebar') }}"><span>Right Sidebar</span></a></li>
									<li><a class="icon solid fa-sitemap" href="{{ url('/nosidebar') }}"><span>No Sidebar</span></a></li>
								</ul>
							</nav>
