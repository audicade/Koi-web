...
<html>
	...
	<body class="right-sidebar is-preload">
		...
		<script src="{{ asset('landing') }}/js/data-table/dataTables.bootstrap.min.js"></script>
		<script src="{{ asset('landing') }}/js/data-table/datatables.min.js"></script>
		<script src="{{ asset('landing') }}/js/data-table/dataTables.buttons.min.js"></script>
		<script src="{{ asset('landing') }}/js/data-table/buttons.bootstrap.min.js"></script>
		<script src="{{ asset('landing') }}/js/data-table/jszip.min.js"></script>
		<script src="{{ asset('landing') }}/js/data-table/vfs_fonts.js"></script>
		<script src="{{ asset('landing') }}/js/data-table/buttons.html5.min.js"></script>
		<script src="{{ asset('landing') }}/js/data-table/buttons.print.min.js"></script>
		<script src="{{ asset('landing') }}/js/data-table/buttons.colVis.min.js"></script>
